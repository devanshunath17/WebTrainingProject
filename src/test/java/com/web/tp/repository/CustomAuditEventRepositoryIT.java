package com.web.tp.repository;

import com.web.tp.TrainingProjectApp;

import com.web.tp.config.Constants;
import com.web.tp.config.audit.AuditEventConverter;
import com.web.tp.domain.PersistentAuditEvent;
...
import static com.web.tp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
